...
//
//     final weatherCityResponseModel = weatherCityResponseModelFromJson(jsonString);

import 'dart:convert';

WeatherCityResponseModel weatherCityResponseModelFromJson(String str) => WeatherCityResponseModel.fromJson(json.decode(str));

String weatherCityResponseModelToJson(WeatherCityResponseModel data) => json.encode(data.toJson());

class WeatherCityResponseModel {
    WeatherCityResponseModel({
        this.data,
        this.cityName,
        this.lon,
        this.timezone,
    ...
    factory WeatherCityResponseModel.fromJson(Map<String, dynamic> json) => WeatherCityResponseModel(
